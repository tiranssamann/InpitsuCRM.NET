...
namespace Inpitsu.Repositories.Migrations
{
    ...
    [Migration("20230223101957_drugItemsUpdate")]
    partial class drugItemsUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inpitsu.Data.Models.Board", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inpitsu.Data.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inpitsu.Data.Models.ReleaseDrugItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReleaseDrugItems");
                });

            modelBuilder.Entity("Inpitsu.Data.Models.ReleaseDrugs", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inpitsu.Data.Models.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inpitsu.Data.Models.Chat", b =>
                {
                    b.HasOne("Inpitsu.Data.Models.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId");

                    b.HasOne("Inpitsu.Data.Models.User", "ToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Inpitsu.Data.Models.Drug", b =>
                {
                    ...
                    b.HasOne("Inpitsu.Data.Models.ReleaseDrugs", "ReleaseDrug")
                        .WithMany()
                        .HasForeignKey("ReleaseDrugId");

                    b.Navigation("ComingDrug");

                    b.Navigation("ReleaseDrug");
                });
            ...
            modelBuilder.Entity("Inpitsu.Data.Models.Task", b =>
                {
                    b.HasOne("Inpitsu.Data.Models.Board", "Board")
                        .WithMany("Tasks")
                        .HasForeignKey("BoardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Inpitsu.Data.Models.User", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Inpitsu.Data.Models.User", "Owner")
                        .WithMany()
